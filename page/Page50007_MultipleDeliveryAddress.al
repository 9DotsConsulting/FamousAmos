...
page 50007 "Multiple Delivery Address"
{
    ...
    PageType = Card;
    SourceTable = "Multiple Delivery Address";
    ...
    local procedure OnAfterOnNewRecord(var Customer: Record Customer; var ShipToAddress: Record "Multiple Delivery Address")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnNewRecord(var Customer: Record Customer; var IsHandled: Boolean; var ShipToAddress: Record "Multiple Delivery Address")
    begin
    end;
}
