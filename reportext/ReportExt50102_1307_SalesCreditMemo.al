reportextension 50102 SalesCreditMemo extends "Standard Sales - Credit Memo"
{
    dataset
    {
        add(Header)
        {
            ...
            //Field 12: Return Order No (Your Reference) - Temporary link for Phase 1
    ...
    rendering
    {
        layout("Famous Amos - Sales Credit Memo")
        {
            Type = RDLC;
            //Type = Word;
            LayoutFile = './reportextlayout/ReportExt50102_1307_SalesCreditMemo.rdlc';
            //LayoutFile = './reportextlayout/ReportExt50102_1307_SalesCreditMemo.docx';
        }
    }
    ...
    var
        ...
        RunningNo: Integer;
        CountNo: Integer;
        currentLine: record "Sales Cr.Memo Line";
}
